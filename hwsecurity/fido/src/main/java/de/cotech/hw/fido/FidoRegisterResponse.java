...
public abstract class FidoRegisterResponse implements Parcelable {
    ...
    public static FidoRegisterResponse create(byte[] bytes, String clientData, Parcelable customData) {
        return new AutoValue_FidoRegisterResponse(bytes, clientData, customData);
    }
}