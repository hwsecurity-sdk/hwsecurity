...
public class SecurityStatusNotSatisfiedException extends SecurityKeyException {
    ...
    public SecurityStatusNotSatisfiedException(String longErrorMessage) {
        super(longErrorMessage, "SECURITY_STATUS_NOT_SATISFIED", SW_SECURITY_STATUS_NOT_SATISFIED);
    }
}
