...
public class AuthenticationMethodBlockedException extends SecurityKeyException {
    ...
    public AuthenticationMethodBlockedException(String longErrorMessage) {
        super(longErrorMessage, "AUTHENTICATION_METHOD_BLOCKED", SW_AUTHENTICATION_METHOD_BLOCKED);
    }
}
