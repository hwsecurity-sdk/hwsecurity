...
public class ConditionsNotSatisfiedException extends SecurityKeyException {
    ...
    public ConditionsNotSatisfiedException() {
        super("CONDITIONS_NOT_SATISFIED", SW_CONDITIONS_NOT_SATISFIED);
    }

    public ConditionsNotSatisfiedException(String longErrorMessage) {
        super(longErrorMessage, "CONDITIONS_NOT_SATISFIED", SW_CONDITIONS_NOT_SATISFIED);
    }
}
