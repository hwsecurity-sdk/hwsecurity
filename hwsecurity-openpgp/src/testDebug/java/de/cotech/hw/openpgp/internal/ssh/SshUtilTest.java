...
public class SshUtilTest {
    ...
    @Test
    public void encodeEcPublicKeyString() throws Exception {
        ECPublicKey ecPublicKey = JcaTestUtils.parseEcPublicKey(ECDSA_PUBLIC);
        String encodedKey = SshUtil.encodeEcPublicKeyString(SECObjectIdentifiers.secp256r1, ecPublicKey);
        Assert.assertEquals("ecdsa-sha2-nistp256 " + ECDSA_OPENSSH_PUBLIC_B64, encodedKey);
    }
    ...
    @Test
    public void encodeRsaPublicKeyString() throws Exception {
        RSAPublicKey rsaPublicKey = JcaTestUtils.parseRsaPublicKey(RSA_PUBLIC);
        String encodedKey = SshUtil.encodeRsaPublicKeyString(rsaPublicKey);
        Assert.assertEquals("ssh-rsa " + RSA_OPENSSH_PUBLIC_B64, encodedKey);
    }
