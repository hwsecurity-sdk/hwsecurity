...
public abstract class OpenPgpSecurityKeyConnectionModeConfig implements Parcelable {
    ...
    @Deprecated
    List<byte[]> getAidPrefixes() {
        return getOpenPgpAidPrefixes();
    }
    ...
    public static class Builder {
         ...
         *
         * @deprecated use {@link #addDefaultOpenPgpAidPrefixes}
         */
        @Deprecated
        public Builder addDefaultAidPrefixes() {
            return addDefaultOpenPgpAidPrefixes();
        }
